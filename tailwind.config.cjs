  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        rhuan: "url(../../assets/imgs/rhuan.jpeg)",
        rita: "url(../../assets/imgs/rita.jpeg)",
        jaime: "url(../../assets/imgs/jaime.jpeg)",
        ingrid: "url(../../assets/imgs/ingrid.jpeg)",
        gerlane: "url(../../assets/imgs/gerlane.png)",
      },
    },
  },
  plugins: [
